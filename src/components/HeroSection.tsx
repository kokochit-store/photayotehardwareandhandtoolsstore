      ...
      <div className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-2xl space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold leading-tight text-foreground">
            သင့်ရဲ့ Style ကို
            <br />
            <span className="text-primary">ပြောင်းလဲ</span>လိုက်ပါ
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-md leading-relaxed">
            အရည်အသွေးမြင့် ပစ္စည်းများကို ဈေးနှုန်းသက်သာစွာ ရယူလိုက်ပါ။ 
            နောက်ဆုံးပေါ် ဒီဇိုင်းများ ရောက်ရှိနေပါပြီ။
          </p>
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <Button asChild variant="outline" size="lg">
              <Link to="/products">Collection ကြည့်ရန်</Link>
            </Button>
          </div>
        </div>
      </div>
